        ...
        voices: [
            ...
            },
            {
                ...
                audio: "syphfride/light_syphfride/영웅화면10.mp3"
                        ...
                        {
                id: "v_auto_1771367972",
                label: "영웅 화면 11",
                transcript: "드래곤은 주기적으로 수면기에 들어가요. 조금 경우가 다르지만 저도 예외가 아니죠. 수면기는 멀었으니 걱정하지 마시길. 오더라도 좀 참아보죠, 뭐.",
                audio: "syphfride/light_syphfride/영웅화면11.mp3"
            },
            {
                id: "v_auto_1771368007",
                label: "영웅 화면 12",
                transcript: "용인족, 흥미로운 아이들이랍니다. 동방의 용들에게 축복 받은 아이들이죠. 고향을 떠났더라도 말이에요.",
                audio: "syphfride/light_syphfride/영웅화면12.mp3"
            },
            {
                id: "v_auto_1771368052",
                label: "영웅 화면 13",
                transcript: "흠, 살면서 정말 여러 가지 독한 술들을 마셔봤지만, 취하지 못한다는 것은 아쉽네요. 술 취한 단명종이 얼마나 멍청한 짓을 할 수 있는지 아시나요? 한 번 쯤 그래보고 싶기도 한데.",
                audio: "syphfride/light_syphfride/영웅화면13.mp3"
            },
            {
                id: "v_auto_1771368095",
                label: "영웅 화면 14",
                transcript: "살면서 마셔본 가장 독한 술은, 북방 대륙의 거인들이 담은 술이었죠. 아, 물론 취하진 않았어요.",
                audio: "syphfride/light_syphfride/영웅화면14.mp3"
            },
            {
                id: "v_auto_1771368141",
                label: "영웅 화면 15",
                transcript: "헬가, 발터, 아슬란. 모두 2차 마도대전 때 최전방에서 싸우던 친구들이에요. 그들 몸에 흉터, 보셨죠? 치유에도 한계가 있는 법이죠.",
                audio: "syphfride/light_syphfride/영웅화면15.mp3"
            },
            {
                id: "v_auto_1771368204",
                label: "영웅 화면 16",
                transcript: "제가 좋아하는 음식이라면, 레드 와인을 곁들인 육즙이 뚝뚝 떨어지는 레어 스테이크. 하, 왜요? 저도 고기 좋아한다고요.",
                audio: "syphfride/light_syphfride/영웅화면16.mp3"
            },
            {
                id: "v_auto_1771368245",
                label: "영웅 화면 17",
                transcript: "해산물은 별로. 그래서, 사르디나는 잘 가지 않게 되더군요.",
                audio: "syphfride/light_syphfride/영웅화면17.mp3"
            },
            {
                id: "v_auto_1771368291",
                label: "영웅 화면 18",
                transcript: "검은… 산양? 아니, 이 자는 다르군.",
                audio: "syphfride/light_syphfride/영웅화면18.mp3"
            },
            {
                id: "v_auto_1771368325",
                label: "영웅 화면 19",
                transcript: "부상자가 생기면 불러 주시길. 그 외의 용무는 거절할게요.",
                audio: "syphfride/light_syphfride/영웅화면19.mp3"
            },
            {
                id: "v_auto_1771368362",
                label: "영웅 화면 20",
                transcript: "아니, 드래곤으로 안 변해요! 안 하는 게 아니라, 못 한다고요! 설마 기대했나요?",
                audio: "syphfride/light_syphfride/영웅화면20.mp3"
            }
        ...
        voices: [
            ...
            },
            {
                ...
                audio: "lucilica/lucil (24).mp3"
                        ...
                        {
                id: "v_auto_1771369769",
                label: "영웅 화면 18",
                transcript: "성인이나 현자들에게도 약점은 있는 법이에요. 자기 과시는 독이나 다름 없지요. 언제나 경계하고 주의해야만 발전할 수 있을 테니까요.",
                audio: "lucilica/lucil (25).mp3"
            },
            {
                id: "v_auto_1771369816",
                label: "영웅 화면 19",
                transcript: "가끔…. 다닐이 그리울 때가 있어요. 물론 이곳의 행정도 훌륭하지만 그만큼 유능한 비서관은 쉽게 만날 수 있는 인연이 아니니까요.",
                audio: "lucilica/lucil (26).mp3"
            },
            {
                id: "v_auto_1771369847",
                label: "영웅 화면 20",
                transcript: "요즘 루미에 경에게 스케이트를 배우고 있어요. 본 강의보다는 사담이 몇 배나 많긴 해도 유익한 시간이랍니다. 엘펜하임 출신이 빙판에 약해서는 안 되니까요.",
                audio: "lucilica/lucil (27).mp3"
            },
            {
                id: "v_auto_1771369933",
                label: "영웅 화면 21",
                transcript: "바네사 경이 연주회에 초대해 주셔서 다녀왔어요. 음악은 훌륭한 취미죠. 스트레스 해소에도 도움을 주고요. 저도 어릴 적에 피아노를 시도해 본 적이 있는데, 실수로 건반을 부숴 먹는 바람에. …아차, 이 뒤는 비밀이에요.",
                audio: "lucilica/lucil (28).mp3"
            },
            {
                id: "v_auto_1771370032",
                label: "영웅 화면 22",
                transcript: "저는 우울한 때가 없냐고요? 그럴 리가요. 짜증도 나고, 우울할 때도 있고, 화도 나는 법이지요. 그렇지만 한 순간의 감정에 매몰되어선 앞으로 나아갈 수 없어요. 기분이 태도가 돼서는 안 되니까요.",
                audio: "lucilica/lucil (29).mp3"
            },
            {
                id: "v_auto_1771370075",
                label: "영웅 화면 23",
                transcript: "바레타 경과 대련하는 건 즐거워요. 형태가 비슷한 무기를 사용하지만 방식은 전혀 다르거든요. 가끔 라샤드가 나타나서 방해할 때가 있다는 게 문제이긴 한데.",
                audio: "lucilica/lucil (30).mp3"
            },
            {
                id: "v_auto_1771370176",
                label: "영웅 화면 24",
                transcript: "이거, 말인가요? 발터 경에게 드릴 보답이에요. 얼마 전에 품질이 좋은 원두를 선물 받았거든요. 우리 비서관이 가끔 타 오던 커피도 못지 않게 훌륭했던 기억이 나서, 맛보여 드리려고 오랜만에 연락해 물건을 공수했죠. 네? 더 이상…. 선물이 아닌 것 같다고요?",
                audio: "lucilica/lucil (31).mp3"
            },
            {
                id: "v_auto_1771370246",
                label: "영웅 화면 25",
                transcript: "어라, 아우레아 님. 팔은 왜 잡으시는 거죠? 네? 모델이요? 아, 잠깐…! 저 이제야 파견해서 돌아온 참인데!",
                audio: "lucilica/lucil (32).mp3"
            },
            {
                id: "v_auto_1771370357",
                label: "영웅 화면 26",
                transcript: "그때…. 두렵지 않았냐고요? 그럴 리가 있나요? 당연히 두려웠죠. 라플라스는 갑자기 이상한 소리나 해 대질 않나, 운신은 제한되질 않나. 그래도 아득바득 버텨낸 결과가 지금이라면, 그리 나쁜 결말은 아니로군요. 어머, 감동했나요?",
                audio: "lucilica/lucil (33).mp3"
            },
            {
                id: "v_auto_1771370438",
                label: "영웅 화면 27",
                transcript: "그대 주변에는 이상하게 인재가 많아요. 상등품의 장비를 아무렇지도 않게 술술 만들어 오는 린 양도 그렇고 잠은 자는 건지 의문인 루인 경도 그렇고. 어, 저도 포함된다고요? 어머. 호호! 어머, 이제 그런 말도 할 줄 알고?",
                audio: "lucilica/lucil (34).mp3"
            },
            {
                id: "v_auto_1771370514",
                label: "영웅 화면 28",
                transcript: "변화가 두려울 때도 있지요. 저도 사람인데다, 나름 실패도 겪어 보았거든요. 다만, 멈춰 서서는 의미가 없다는 걸 남들보다 빨리 깨달은 것 뿐이에요.",
                audio: "lucilica/lucil (35).mp3"
            },
            {
                id: "v_auto_1771370538",
                label: "영웅 화면 29",
                transcript: "식사는 했나요? 아직이라면 함께 가시죠.",
